                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <script>
                        ...
                        function updateApproverOptions() {
                            ...
                            selects.forEach(select => {
                                ...
                                Array.from(select.options).forEach(option => {
                                    ...
                                    // Disable if selected elsewhere, enable otherwise
                                    // Condition: Value is in selectedValues AND Value is NOT current select's value
                                    if (selectedValues.includes(option.value) && option.value !== currentVal) {
                                        option.disabled = true;
                                        // Optional: Add visual cue like text color change
                        ...
                        function addApprover(selectedId = null) {
                            ...
                            updateApproverOptions(); // Update immediately to check against existing
                        }
                        ...
                        // Initialize from old input or empty
                        document.addEventListener('DOMContentLoaded', function() {
                            const initialData = Array.isArray(oldApprovers) ? oldApprovers : Object.values(oldApprovers);
