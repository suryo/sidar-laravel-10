...
<div class="px-4 sm:px-0">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-6">
            <!-- Absen Masuk -->
            @if(!$todayAttendance)
            <a href="{{ route('attendance.create') }}" class="w-full sm:w-auto justify-center inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
            ...
            <a href="{{ route('attendance.checkout-view') }}" class="w-full sm:w-auto justify-center inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
