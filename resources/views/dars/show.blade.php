                    ...
                    <form action="{{ route('dars.approve', $dar->id) }}" method="POST" class="flex-1">
                        ...
                        <div class="mb-4 bg-yellow-50 p-4 rounded-md border border-yellow-200">
                            <label class="flex items-start">
                                <input type="checkbox" required name="read_confirmation" class="mt-1 h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                                <span class="ml-2 text-sm text-gray-700">
                                    Saya menyatakan sudah membaca laporan aktivitas harian ini dan menyetujuinya.
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notes" id="approve_notes" rows="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm" placeholder="Add approval notes..."></textarea>
                        </div>
