...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menus = [
            ...
            [
                'title' => 'Ijin Terlambat',
                'route_name' => 'late-permissions.index',
                'icon_svg' => '<svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>', 
                'order' => 6,
            ],
            [
                'title' => 'Lupa Check Clock',
                'route_name' => 'forgot-clocks.index',
            ...
            [
                ...
                'route_name' => 'overtimes.index',
                'icon_svg' => '<svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>', // Clock icon variant
                'order' => 9,
            ],
            [
                'title' => 'Cuti & Izin',
